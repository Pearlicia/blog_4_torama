                ...
                <div class="info">
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <h3 class="heading-title" >{{ $settings->site_name }}</h3>
                            ...
                            <p class="heading-text">We can build rich and beautiful technology experiences for your businesses, 
                                increase your productivity and grow your business.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <a href="#" class="title">{{ $settings->address }}</a>
                                <p class="sub-title">Bayelsa, State</p>
                            </div>
                        </div>
                    </div>
                </div>
